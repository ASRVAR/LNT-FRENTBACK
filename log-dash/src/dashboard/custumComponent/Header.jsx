    ...
    <>
        ...
        {/* <!--Start  Navbar--> */}
         ...
         <a href="index.html" className="logo">
            <img className="img-fluid able-logo" src="assets/images/logo.png" alt="Theme-logo" /></a>
         <nav className="navbar navbar-static-top">
            ...
            <ul className="top-nav lft-nav">
               <li>
                  <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" className="dropdown-toggle drop icon-circle drop-image">
                     <i className="ti-files"> </i><span> Files</span>
                  </a>
               </li>               
               <li className="dropdown">
                  <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" className="dropdown-toggle drop icon-circle drop-image">
                     <span>Dropdown </span><i className=" icofont icofont-simple-down"></i>
                  </a>
            ...
            <div className="navbar-custom-menu f-right">
              <div className="upgrade-button">
                <a href="#" className="icon-circle txt-white btn btn-sm btn-primary upgrade-button">
               ...
               <ul className="top-nav">
                  ...
                  <li className="dropdown">
                     <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" className="dropdown-toggle drop icon-circle drop-image">
                        <span><img className="img-circle " src="assets/images/avatar-1.png" style={{width:40}} alt="User Image" /></span>
